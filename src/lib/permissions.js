...
export const MENU_CATALOG = [
  ...
  { key: 'report_inventory', label: 'Laporan Inventaris', group: 'laporan', actions: ['view'] },
  { key: 'report_profit_loss', label: 'Laporan Laba Rugi', group: 'laporan', actions: ['view'] },
...
export const ROUTE_ACCESS = [
  ...
  { route: '/hpp', perm: 'hpp' },
  { route: '/reports/inventory', perm: 'report_inventory' },
  { route: '/reports/profit-loss', perm: 'report_profit_loss' },
