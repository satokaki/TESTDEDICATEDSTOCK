...
// Hanya tipe ini yang membutuhkan properti teknis resep.
const RECIPE_TYPES = [
  'RAW_MATERIAL',
  'PREMIX'
];
...
/*
Semua item berikut mempunyai nilai biaya/HPP.
...
Tidak perlu mengubah tipe menjadi RAW_MATERIAL
hanya supaya harga/HPP dapat disimpan.
*/
...
const catTypeLabel = (materialType) => {
  ...
  const t =
    CATEGORY_TYPE_BY_MATERIAL_TYPE[materialType] ||
    'bahan';
        ...
        try {
          ...
          if (
            ...
            try {
              ...
              // kategori mungkin sudah dihapus
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        /*
        PATCH:
        Harga/HPP tidak lagi dibatasi
        hanya RAW_MATERIAL/PREMIX.
        */
...
====================================================== */}
      ...
      <div className="mb-3 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-[12px] text-amber-700">
        ...
        (essence, nicotine, PG, VG, premix, botol, label,
        stiker, pita cukai).

        Master Barang khusus untuk{' '}
                  ...
                  : (
                    ...
                    >
                      ...
                      <SelectTrigger className="h-9 text-[13px]">
                        ...
                        <SelectValue
                          placeholder={
                            `Pilih kategori ${catTypeLabel(form.material_type)}`
                          }
                        />
...
{/* CARRIER */}
              ...
              <div className="text-[11px] text-amber-700/80">
                ...
                Bahan premix otomatis ditandai
                "Diproduksi Internal".
                Kode dibuat otomatis format
                PMX-NAMA-KONS-NOMOR.
